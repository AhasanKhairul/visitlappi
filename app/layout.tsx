...
// Newsreader/Archivo/Anton are loaded here as a system-font fallback stack
// under the same CSS variable names the design tokens expect. In a real
// deploy (with normal internet access) swap this block for:
//
...
//
// and use `${newsreader.variable} ${archivo.variable} ${anton.variable}` on <body> below.
